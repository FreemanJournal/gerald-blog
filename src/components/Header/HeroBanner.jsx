...
export default function HeroBanner({ home }) {
        ...
        home ? (
          ...
          <div className="bg-emerald-400 headerShadow h-72 flex items-center relative">
            <div className="container flex flex-col  justify-center items-center">
              <div className="w-32 h-32"><img src={`${user?.photoURL}` || '/images/profile.jpg'} alt="Profile" className='w-full h-full rounded-full object-cover' /></div>
              <h1 className='text-white font-bold text-xl md:text-4xl drop-shadow-md capitalize'>{user?.displayName}</h1>
              <p className='text-white md:text-2xl my-5 tracking-wider'>I am a javascript developer and  a good human being.</p>
            </div>
